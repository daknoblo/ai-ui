...
var catalog = map[string]map[string]string{
	EN: {
		...
		"config.reasoning_effort_hint": "(reasoning models only; \"auto\" leaves the decision to the model)",
	...
	DE: {
		...
		"config.reasoning_effort_hint": "(nur Reasoning-Modelle; „auto“ überlässt die Entscheidung dem Modell)",
		"config.log_level":             "Log-Level",
