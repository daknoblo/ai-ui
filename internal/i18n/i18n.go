...
var catalog = map[string]map[string]string{
	EN: {
		...
		"usage.tooltip_last":   "Last answer: %s (%s input / %s output)",
		...
		"config.models_hint":           "(set via AZURE_MODELS; selectable in the chat header)",
	...
	DE: {
		...
		"usage.tooltip_last":   "Letzte Antwort: %s (%s Eingabe / %s Antwort)",
		...
		"config.models_hint":           "(über AZURE_MODELS gesetzt; im Chat-Header wählbar)",
