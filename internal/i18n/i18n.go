...
var catalog = map[string]map[string]string{
	EN: {
		...
		"upload.image_chat_mode":   "%q (images are only used in image mode)",
		...
		"js.upload_blocked": "Uploads blocked – please test the connection in the settings first.",
		...
		"prompt.rag_files":          "Attached documents: %s\n\n",
		"prompt.rag_item":           "[Context %d | Source: %s]\n%s\n\n",
		"prompt.rag_unknown_source": "unknown document",
	...
	DE: {
		...
		"upload.image_chat_mode":   "%q (Bilder werden nur im Bildmodus verwendet)",
		...
		"js.upload_blocked": "Upload gesperrt – bitte zuerst in den Einstellungen die Verbindung testen.",
		...
		"prompt.rag_files":          "Angehängte Dokumente: %s\n\n",
		"prompt.rag_item":           "[Kontext %d | Quelle: %s]\n%s\n\n",
		"prompt.rag_unknown_source": "unbekanntes Dokument",
