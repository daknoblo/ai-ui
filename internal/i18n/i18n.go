...
var catalog = map[string]map[string]string{
	EN: {
		...
		"chat.attach_title":           "Attach files - PDF, Word, Excel, PowerPoint, RTF, text, code and images",
		"chat.attach_option":          "Attach",
		"chat.reasoning_label":        "Reasoning",
		"chat.reasoning_title":        "How much the model thinks before it answers. The available values follow the selected model.",
		...
		"image.source_title":          "%s — attached to the conversation; in image mode it is edited instead of generating a new image",
		"chat.input_placeholder":      "Write a message…",
		"chat.send_title":             "Send",
		"drop.ready_title":            "Drop files here",
		"drop.ready_sub":              "PDF, Word, Excel, PowerPoint, text, code or images",
		...
		"stream.images_dropped":       "⚠ No configured model can read images, so the attached pictures were left out of this answer.",
		"stream.not_supported":        "streaming not supported",
		"stream.pending_chat":         "Writing the answer…",
		"stream.pending_image":        "Generating the image…",
		"stream.pending_image_edit":   "Editing the uploaded image…",
		...
		"foundry.title":                  "Azure Foundry",
		"foundry.identity_hint":          "Authentication uses the container's dedicated Entra service principal. Credentials stay in the environment.",
		"foundry.resource":               "Resource",
		"foundry.not_discovered":         "No successful deployment refresh yet.",
		"foundry.identity_error":         "Identity configuration: %s",
		"foundry.stale":                  "Refresh failed. The last successful inventory and saved selections were retained: %s",
		"foundry.updated_at":             "Inventory last updated: %s",
		"foundry.refresh":                "Refresh deployments",
		"foundry.refreshing":             "Reading deployment metadata...",
		"foundry.refresh_failed":         "Could not refresh deployments: %s",
		"foundry.refreshed":              "Deployment inventory updated. Your selections have not changed.",
		"foundry.deployment":             "Deployment",
		"foundry.model":                  "Base model",
		"foundry.version":                "Version",
		"foundry.state":                  "State",
		"foundry.support":                "Supported operations",
		"foundry.no_deployments":         "No deployments have been discovered. Check the resource and identity, then refresh.",
		"foundry.unsupported_detail":     "Not supported by this app: %s",
		"foundry.roles":                  "Default deployments",
		"foundry.roles_hint":             "Select deployments by purpose and save. Refresh only reads metadata; use the connection check to verify the selected models. Vision/OCR uses the selected chat model when compatible, otherwise the explicit vision selection.",
		"foundry.chat":                   "Chat",
		"foundry.embeddings":             "Text embeddings",
		"foundry.images":                 "Image generation",
		"foundry.image_edits":            "Image editing",
		"foundry.vision":                 "Vision / OCR",
		"foundry.use_chat":               "Use the compatible chat model",
		"foundry.not_configured":         "Not configured",
		"foundry.unavailable_selection":  "%s (unavailable or incompatible)",
		"foundry.chat_filter_hint":       "AZURE_MODELS limits the chat and vision choices. Update or remove this environment filter to show all compatible discovered deployments.",
		"foundry.image_filter_hint":      "AZURE_IMAGE_MODELS limits the image choices. Update or remove this environment filter to show all compatible discovered deployments.",
		"foundry.invalid_selection":      "The selected deployment is not usable: %s",
		"foundry.disabled":               "Identity-backed Foundry mode is not enabled.",
		"foundry.active_index":           "Active embedding index: %s",
		"foundry.unknown_index":          "not initialized or unknown legacy model",
		"foundry.index_error":            "Embedding index: %s",
		"foundry.reindex_warning":        "Changing the embedding model requires rebuilding %d documents (%d text chunks). This sends the stored text to Azure and incurs embedding usage charges. The old index remains active until the rebuild succeeds.",
		"foundry.reindex_hint":           "Save your model selection first. Documents cannot be uploaded or deleted during the rebuild. Chat and images remain available.",
		"foundry.reindex_consent":        "I approve sending the stored text to the selected model and the resulting Azure usage charges.",
		"foundry.reindex":                "Rebuild embedding index",
		"foundry.confirm_required":       "Explicit confirmation is required before rebuilding embeddings.",
		"foundry.selection_changed":      "The embedding selection or model metadata changed. Review the current selection and confirm again.",
		"foundry.reindex_started":        "Embedding index rebuild started.",
		"foundry.reindex_progress":       "Rebuilding embeddings: %d of %d chunks.",
		"foundry.reindex_busy":           "An embedding rebuild is running. Document uploads, document/chat deletion, and embedding selection changes are temporarily unavailable.",
		"foundry.reindex_failed":         "The rebuild did not finish. The previous index was retained: %s",
		"foundry.reindex_done":           "The embedding index was rebuilt successfully.",
		"foundry.reindex_options":        "Rebuild options",
		"foundry.reindex_repeat_warning": "Rebuilding the current index sends %d documents (%d text chunks) to Azure again and incurs embedding usage charges. Use this to repair an index or regenerate changed vector dimensions.",
		"foundry.check_changed":          "Configuration changed during verification. Run the connection check again.",
		"stream.retrieval_failed":        "The document context could not be loaded. Check the embedding index in settings: %s",
		"stream.vision_missing":          "No compatible vision deployment is selected. Select one in settings before sending images.",
		...
		"config.image_key_cross":         "the endpoint belongs to a different resource — set AZURE_IMAGE_API_KEY, the chat key is rejected there (401)",
		...
		"config.reasoning_effort_hint":   "(default for new chats; each chat can change it next to the input field)",
		...
		"check.deployment":         "Deployment %s",
		"check.image_deployment":   "Image deployment %s",
		...
		"upload.ocr_used":          "Read with the vision model: %s.",
		"upload.ocr_item":          "%q (%d pages)",
		"upload.added_one":         "1 file added.",
		"upload.added_many":        "%d files added.",
		...
		"prompt.files_intro":    "\n\nThe user has attached the following files to this conversation. Attached images are part of the message and you can look at them directly; the text of attached documents is provided below as context sections whenever it is relevant.\n\n",
		"prompt.files_item":     "- %s\n",
		"prompt.ocr_system":     "You transcribe scanned pages. Return the text of the page exactly as it appears and keep headings, lists and table rows. Do not summarize, do not comment and do not add anything that is not on the page. Reproduce a table as tab separated rows. If the page holds no readable text, answer with nothing at all.",
		"prompt.ocr_page":       "[Page %d of %d]",
	...
	DE: {
		...
		"chat.attach_title":           "Dateien anhängen – PDF, Word, Excel, PowerPoint, RTF, Text, Code und Bilder",
		"chat.attach_option":          "Anhang",
		"chat.reasoning_label":        "Denkaufwand",
		"chat.reasoning_title":        "Wie viel das Modell vor der Antwort nachdenkt. Die möglichen Werte richten sich nach dem gewählten Modell.",
		...
		"image.source_title":          "%s — hängt an der Unterhaltung; im Bildmodus wird es bearbeitet statt ein neues Bild zu erzeugen",
		"chat.input_placeholder":      "Nachricht schreiben…",
		"chat.send_title":             "Senden",
		"drop.ready_title":            "Dateien hier ablegen",
		"drop.ready_sub":              "PDF, Word, Excel, PowerPoint, Text, Code oder Bilder",
		...
		"stream.images_dropped":       "⚠ Kein konfiguriertes Modell kann Bilder lesen – die angehängten Bilder wurden für diese Antwort weggelassen.",
		"stream.not_supported":        "Streaming wird nicht unterstützt",
		"stream.pending_chat":         "Antwort wird geschrieben…",
		"stream.pending_image":        "Bild wird erzeugt…",
		"stream.pending_image_edit":   "Hochgeladenes Bild wird bearbeitet…",
		...
		"foundry.title":                  "Azure Foundry",
		"foundry.identity_hint":          "Die Anmeldung erfolgt über den eigenen Entra-Service-Principal des Containers. Zugangsdaten bleiben in der Umgebung.",
		"foundry.resource":               "Ressource",
		"foundry.not_discovered":         "Noch keine erfolgreiche Deployment-Abfrage.",
		"foundry.identity_error":         "Identitätskonfiguration: %s",
		"foundry.stale":                  "Aktualisierung fehlgeschlagen. Der letzte erfolgreiche Bestand und die gespeicherte Auswahl bleiben erhalten: %s",
		"foundry.updated_at":             "Bestand zuletzt aktualisiert: %s",
		"foundry.refresh":                "Deployments aktualisieren",
		"foundry.refreshing":             "Deployment-Metadaten werden geladen...",
		"foundry.refresh_failed":         "Deployments konnten nicht aktualisiert werden: %s",
		"foundry.refreshed":              "Deployment-Bestand aktualisiert. Deine Auswahl wurde nicht geändert.",
		"foundry.deployment":             "Deployment",
		"foundry.model":                  "Basismodell",
		"foundry.version":                "Version",
		"foundry.state":                  "Status",
		"foundry.support":                "Unterstützte Funktionen",
		"foundry.no_deployments":         "Keine Deployments ermittelt. Prüfe Ressource und Identität und aktualisiere den Bestand.",
		"foundry.unsupported_detail":     "Von dieser App nicht unterstützt: %s",
		"foundry.roles":                  "Standard-Deployments",
		"foundry.roles_hint":             "Deployments je Zweck auswählen und speichern. Aktualisieren liest nur Metadaten; der Verbindungstest prüft die ausgewählten Modelle. Vision/OCR nutzt das Chat-Modell, wenn es Bilder versteht, ansonsten die ausdrückliche Vision-Auswahl.",
		"foundry.chat":                   "Chat",
		"foundry.embeddings":             "Text-Embeddings",
		"foundry.images":                 "Bilderzeugung",
		"foundry.image_edits":            "Bildbearbeitung",
		"foundry.vision":                 "Vision / OCR",
		"foundry.use_chat":               "Kompatibles Chat-Modell verwenden",
		"foundry.not_configured":         "Nicht konfiguriert",
		"foundry.unavailable_selection":  "%s (nicht verfügbar oder inkompatibel)",
		"foundry.chat_filter_hint":       "AZURE_MODELS begrenzt die Chat- und Vision-Auswahl. Aktualisiere oder entferne diesen Umgebungsfilter, um alle kompatiblen ermittelten Deployments anzuzeigen.",
		"foundry.image_filter_hint":      "AZURE_IMAGE_MODELS begrenzt die Bildauswahl. Aktualisiere oder entferne diesen Umgebungsfilter, um alle kompatiblen ermittelten Deployments anzuzeigen.",
		"foundry.invalid_selection":      "Das ausgewählte Deployment ist nicht verwendbar: %s",
		"foundry.disabled":               "Der identitätsbasierte Foundry-Modus ist nicht aktiviert.",
		"foundry.active_index":           "Aktiver Embedding-Index: %s",
		"foundry.unknown_index":          "nicht initialisiert oder unbekanntes bisheriges Modell",
		"foundry.index_error":            "Embedding-Index: %s",
		"foundry.reindex_warning":        "Der Modellwechsel erfordert die Neuberechnung von %d Dokumenten (%d Textabschnitten). Dabei werden die gespeicherten Texte an Azure gesendet und kostenpflichtige Embeddings erzeugt. Der alte Index bleibt bis zum erfolgreichen Abschluss aktiv.",
		"foundry.reindex_hint":           "Speichere zuerst die Modellauswahl. Während der Neuberechnung können Dokumente weder hochgeladen noch gelöscht werden. Chat und Bilder bleiben verfügbar.",
		"foundry.reindex_consent":        "Ich bestätige das Senden der gespeicherten Texte an das ausgewählte Modell und die dadurch entstehenden Azure-Nutzungskosten.",
		"foundry.reindex":                "Embedding-Index neu berechnen",
		"foundry.confirm_required":       "Vor der Neuberechnung der Embeddings ist eine ausdrückliche Bestätigung erforderlich.",
		"foundry.selection_changed":      "Die Embedding-Auswahl oder die Modell-Metadaten haben sich geändert. Prüfe die aktuelle Auswahl und bestätige erneut.",
		"foundry.reindex_started":        "Die Neuberechnung des Embedding-Index wurde gestartet.",
		"foundry.reindex_progress":       "Embeddings werden neu berechnet: %d von %d Textabschnitten.",
		"foundry.reindex_busy":           "Ein Embedding-Index wird neu berechnet. Dokument-Uploads, das Löschen von Dokumenten/Chats und Änderungen der Embedding-Auswahl sind vorübergehend gesperrt.",
		"foundry.reindex_failed":         "Die Neuberechnung wurde nicht abgeschlossen. Der bisherige Index bleibt erhalten: %s",
		"foundry.reindex_done":           "Der Embedding-Index wurde erfolgreich neu berechnet.",
		"foundry.reindex_options":        "Optionen zur Neuberechnung",
		"foundry.reindex_repeat_warning": "Die erneute Berechnung sendet %d Dokumente (%d Textabschnitte) an Azure und verursacht Embedding-Nutzungskosten. Damit lässt sich ein Index reparieren oder auf geänderte Vektordimensionen umstellen.",
		"foundry.check_changed":          "Die Einstellungen wurden während der Prüfung geändert. Starte den Verbindungstest erneut.",
		"stream.retrieval_failed":        "Der Dokumentkontext konnte nicht geladen werden. Prüfe den Embedding-Index in den Einstellungen: %s",
		"stream.vision_missing":          "Kein kompatibles Vision-Deployment ausgewählt. Wähle eines in den Einstellungen aus, bevor du Bilder sendest.",
		...
		"config.image_key_cross":         "der Endpoint gehört zu einer anderen Ressource — AZURE_IMAGE_API_KEY setzen, der Chat-Key wird dort abgelehnt (401)",
		...
		"config.reasoning_effort":        "Denkaufwand",
		"config.reasoning_effort_hint":   "(Vorgabe für neue Chats; jeder Chat kann sie neben dem Eingabefeld ändern)",
		"config.log_level":               "Log-Level",
		...
		"check.embedding_endpoint": "Embedding-Endpoint",
		"check.deployment":         "Deployment %s",
		"check.image_deployment":   "Bild-Deployment %s",
		...
		"upload.item_failed":       "%q (%s)",
		"upload.ocr_used":          "Mit dem Bildmodell gelesen: %s.",
		"upload.ocr_item":          "%q (%d Seiten)",
		"upload.added_one":         "1 Datei hinzugefügt.",
		"upload.added_many":        "%d Dateien hinzugefügt.",
		...
		"prompt.files_intro":    "\n\nDer Nutzer hat die folgenden Dateien an diese Unterhaltung angehängt. Angehängte Bilder sind Teil der Nachricht und du kannst sie direkt ansehen; der Text angehängter Dokumente steht unten als Kontextabschnitt, sofern er relevant ist.\n\n",
		"prompt.files_item":     "- %s\n",
		"prompt.ocr_system":     "Du transkribierst gescannte Seiten. Gib den Text der Seite exakt so wieder, wie er dort steht, und behalte Überschriften, Listen und Tabellenzeilen bei. Fasse nichts zusammen, kommentiere nicht und ergänze nichts, was nicht auf der Seite steht. Gib eine Tabelle als tabulatorgetrennte Zeilen wieder. Enthält die Seite keinen lesbaren Text, antworte mit gar nichts.",
		"prompt.ocr_page":       "[Seite %d von %d]",
