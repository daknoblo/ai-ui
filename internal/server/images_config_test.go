...
func TestImageModelPreservesChatChoiceAndDefault(t *testing.T) {
	cfg := config.Config{ImageDeployment: "gpt-image-2"}
	chat := storage.Chat{ID: 7, Model: "gpt-5.1", ImageModel: "MAI-Image-2.5"}
